...
TweenLite.from([arrow1, arrow2], {duration: .5, delay:2, stagger: .2, opacity: 0, ease: "power2.in"});
TweenLite.from(explore, {duration: .8, delay:2.5, opacity: 0, ease: "power2.in" });
TweenLite.from(logo, {duration: .8, delay: 2.7, opacity: 0, ease: "power2.in" })
...
TweenLite.to([car, title4, title3], {duration: .3, stagger: .1, x: 50, opacity: 0, delay: 10});
...
TweenLite.to(bgLogo, {duration: 1.5, delay: 10.5, css:{opacity: "1"}, ease: "power2.in" });
...
TweenLite.from([blue,orange, red], {duration:.8, delay: 16, opacity: 0, x: 50, stagger: .5});
TweenLite.from(blueCar, {duration: 1, delay: 17, opacity: 0});
TweenLite.to([arrow1,arrow2, logo, explore, exploreCont ], {opacity: 1, delay: 18});
...
// allow color pick after certain time
setTimeout(()=>{colorPick()},16000)
